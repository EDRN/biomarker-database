		...
		<div class="optionsContainer" style="padding-left:10px;">
			<div class="option">
				...
				<ul><li><a href="browse/biomarkers/">View Existing Biomarkers</a></li>
					<li><span class="pseudolink" onclick="Element.hide('newStudy');Effect.Appear('newBiomarker');">Create a new Biomarker</span></li>
				</ul>
			</div>
			<div class="option">
				<h4>Studies</h4>
				<ul><li><a href="browse/studies/">View Existing Studies</a></li>
					<li><span class="pseudolink" onclick="Element.hide('newBiomarker');Effect.Appear('newStudy');">Create a new Study</span></li>
				</ul>
			</div>
			<div class="option">
				<h4>Publications</h4>
