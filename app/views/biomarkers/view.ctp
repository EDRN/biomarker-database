...
<div id="content">
		...
		<h2><span id="name" class="editable object:biomarker id:<?php echo $biomarker['Biomarker']['id']?> attr:name"><?php echo $biomarkerName?></span> <?php echo ((($biomarker['Biomarker']['isPanel']) == 1) ? '(Panel)':'');?></h2>
		...
		<table><!-- 
			<tr>
			  <th style="text-align:left;width:50px;text-decoration:underline;">Is a Panel?</th>
			</tr>-->
			<tr>
			...
			<tr>
			  <td style="border-top:dotted 1px #999;padding-top:3px;">Belongs to Panel(s):</td>
			</tr>
			<tr>
