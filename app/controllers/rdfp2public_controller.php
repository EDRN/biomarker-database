...
class Rdfp2publicController extends AppController {
	...
	private function escapeEntities($str) {
		...
		/* Multiple characters */
		$source = str_replace("ÄÅ¼Ë", "&quot;",  $str);
		$source = str_replace("Ã¢â€žË˜", "&trade;", $source);
		$source = str_replace("\'",  "&apos;",  $source);
		$source = str_replace("Ã¢â‚¬â„¢", "&apos",   $source);
		...
		$source = str_replace("â€”", "&minus;",  $source);
		$source = str_replace("â€“", "&minus;",  $source);
		$source = str_replace("â€œ", "&quot;",   $source);
		$source = str_replace("â€", "&quot;",   $source);
