...
<div style="position:relative;min-height:430px;">
	<div style="background-color:#fff;position:absolute;left:0px;height:100%;width:40%;">
		<div style="padding-left:5px;padding-right:5px;">
			...
			<img src="/img/question-mark.png" style="float:left;padding-right:5px;padding-top:4px"/>
	...
	<div style="background-color:#fff;position:absolute;left:41%;height:100%;margin-top:10px;border-left:solid 1px #999;border-right:solid 1px #999;width:29%;">
		<div style="padding-left:10px;padding-right:10px;">
			...
			<ul style="list-style-type:square;color:#500003;">
			  <li><a href="/biomarkers/">Browse Biomarkers</a></li>
			  <!--<li><a href="#">Browse Biomarker Panels</a></li>-->
		
			  <li><a href="/biomarkers/create">Create a New Biomarker <!--/ Panel--></a></li>
			</ul>
			<h4>Studies</h4>
			<ul style="list-style-type:square;color:#500003;">
			  <li><a href="/studies/">Browse Studies</a></li>
		
			  <li><a href="/studies/create">Create non-EDRN Study</a></li>
			</ul>
			<h4>Publications</h4>
			<ul style="list-style-type:square;color:#500003;">
			  <li><a href="/publications/">Browse Publications</a></li>
			  <li><a href="/publications/import">Import from Pub-Med</a></li>
			</ul>
			<h4>Terms / Glossary</h4>
			<ul style="list-style-type:square;color:#500003;">
			  <li><a href="/terms/">Browse Terms</a></li>
			  <li><a href="/terms/define">Define a Term</a></li>
			</ul>
			<h4>Sites</h4>
			<ul style="list-style-type:square;color:#500003;">
			  <li><a href="/sites/">Browse Sites</a></li>
			  <li><a href="/sites/create">Define non-EDRN Site</a></li>
			</ul>
	...
	<div style="background-color:#fff;position:absolute;left:71%;height:100%;width:29%;margin-top:10px;">
		...
		<ul style="list-style-type:square;color:#500003;">
			<li><a href="/auditors/weeklySummary">All activity this week</a></li>
			<li><a href="/auditors/previousMonth">All activity this month</a></li>
		...
		<h4>Security...</h4>
		<ul style="list-style-type:square;color:#500003;">
			<li><a href="/acls/manage">Bulk manage data security settings</a></li>
		</ul>

		<h4>Data Access APIs</h4>
		<ul style="list-style-type:square;color:#500003;">
			<li><a href="/apis">Browse Available APIs</a></li>
		</ul>
	</div>
</div>
