...
<div class="menu">
	...
	<div id="breadcrumbs">
		...
		<a href="/studies/view/<?php echo $study['Study']['id']?>"><?php echo $study['Study']['title']?> </a> : 
		<span>Resources</span>
	</div><!-- End Breadcrumbs -->
...
<div id="smalllinks">
		<ul>
		  <li class=""><a href="/studies/view/<?php echo $study['Study']['id']?>">Basics</a></li>
		  <li class=""><a href="/studies/publications/<?php echo $study['Study']['id']?>">Publications</a></li>
		  <li class="activeLink"><a href="/studies/resources/<?php echo $study['Study']['id']?>">Resources</a></li>
		</ul>
		<div class="clr"><!--  --></div>
</div>
...
<div id="addstudyres" class="addstudyres" style="display:none;">
			<form action="/studies/addResource" method="POST" style="margin-top:5px;">
		...
		<ul style="margin-left:20px;margin-top:10px;font-size:90%;">
			<?php foreach ($study['StudyResource'] as $resource):?>
				<li><div class="studyressnippet">
						<a href="http://<?php echo $resource['URL']?>"><?php echo $resource['URL']?></a>&nbsp;&nbsp;[<a href="/studies/removeResource/<?php echo $study['Study']['id']?>/<?php echo $resource['id']?>">Remove this association</a>]<br/>
...
<script type="text/javascript">
  ...
  new Autocompleter.Ajax.Xhtml(
   $('publicationsearch'),
     '/studies/ajax_autocompletePublications', {
