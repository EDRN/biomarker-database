...
<div id="smalllinks">
		<ul>
		  ...
		  <li class="activeLink"><a href="/studies/publications/<?php echo $study['Study']['id']?>">Publications</a></li>
...
<div id="addstudypub" class="addstudypub fadeOut">
	<form action="/studies/addPublication" method="POST">
...
<?php foreach ($study['Publication'] as $publication):?>
	<li><div class="studypubsnippet">
			<a href="/publications/view/<?php echo $publication['id']?>"><?php echo $publication['title']?></a> &nbsp;[<a href="/studies/removePublication/<?php echo $study['Study']['id']?>/<?php echo $publication['id']?>">Remove this association</a>]<br/>
