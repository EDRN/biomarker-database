...
<div id="smalllinks">
		<ul>
		  ...
		  <li class="activeLink"><a href="/biomarkers/publications/<?php echo $biomarker['Biomarker']['id']?>">Publications</a></li>
...
<div id="addstudypub" class="addstudypub fadeOut">
	<form action="/biomarkers/addPublication" method="POST">
...
<?php foreach ($biomarker['Publication'] as $publication):?>
	<li><div class="studypubsnippet">
			<a href="/publications/view/<?php echo $publication['id']?>"><?php echo $publication['title']?></a> <br/>
			<span style="color:#555;font-size:90%;">Author:
			    ...
			    <?php echo $publication['published']?>, &nbsp;
                            ...
                            <a style="color:#d55" href="/biomarkers/removePublication/<?php echo $biomarker['Biomarker']['id']?>/<?php echo $publication['id']?>">x Remove this association</a>
                        </span>
		</div>
	</li>
<?php endforeach;?>
