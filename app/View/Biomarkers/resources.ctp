...
<div id="smalllinks">
		<ul>
		  ...
		  <li class="activeLink"><a href="/biomarkers/resources/<?php echo $biomarker['Biomarker']['id']?>">Resources</a></li>
		</ul>
		<div class="clr"><!--  --></div>
</div>
...
<div id="addstudyres" class="addstudyres fadeOut" style="margin-left:20px">
	<form action="/biomarkers/addResource" method="POST" style="margin-top:5px;">
...
<ul style="margin-left:20px;margin-top:10px;font-size:90%;">
	<?php foreach ($biomarker['BiomarkerResource'] as $resource):?>
		<li><div class="studyressnippet">
				<a href="<?php echo $resource['URL']?>"><?php echo $resource['URL']?></a>&nbsp;&nbsp;<a style="color:#d55;font-size:90%" href="/biomarkers/removeResource/<?php echo $biomarker['Biomarker']['id']?>/<?php echo $resource['id']?>">x Remove this association</a><br/>
