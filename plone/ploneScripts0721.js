...
// http://edrndemo.org/portal_javascripts/event-registration.js?original=1
...
// http://edrndemo.org/portal_javascripts/register_function.js?original=1
...
/* - cssQuery.js - */
// http://edrndemo.org/portal_javascripts/cssQuery.js?original=1
...
// http://edrndemo.org/portal_javascripts/plone_javascript_variables.js?original=1
var portal_url='http://edrndemo.org';var form_modified_message='Your form has not been saved. All changes you have made will be lost.';var form_resubmit_message='Your already clicked the submit button. Do you really want to submit this form again?';var external_links_open_new_window=false;var external_links_in_content_only=true;

/* - nodeutilities.js - */
// http://edrndemo.org/portal_javascripts/nodeutilities.js?original=1
...
/* - cookie_functions.js - */
// http://edrndemo.org/portal_javascripts/cookie_functions.js?original=1
...
/* - livesearch.js - */
// http://edrndemo.org/portal_javascripts/livesearch.js?original=1
...
/* - fullscreenmode.js - */
// http://edrndemo.org/portal_javascripts/fullscreenmode.js?original=1
...
/* - select_all.js - */
// http://edrndemo.org/portal_javascripts/select_all.js?original=1
...
/* - dropdown.js - */
// http://edrndemo.org/portal_javascripts/dropdown.js?original=1
...
/* - dragdropreorder.js - */
// http://edrndemo.org/portal_javascripts/dragdropreorder.js?original=1
var ploneDnDReorder={}
...
// http://edrndemo.org/portal_javascripts/mark_special_links.js?original=1
...
// http://edrndemo.org/portal_javascripts/collapsiblesections.js?original=1
...
// http://edrndemo.org/portal_javascripts/highlightsearchterms.js?original=1
...
/* - se-highlight.js - */
// http://edrndemo.org/portal_javascripts/se-highlight.js?original=1
...
// http://edrndemo.org/portal_javascripts/first_input_focus.js?original=1
...
// http://edrndemo.org/portal_javascripts/folder_contents_filter.js?original=1
...
// http://edrndemo.org/portal_javascripts/folder_contents_hideAddItems.js?original=1
...
/* - styleswitcher.js - */
// http://edrndemo.org/portal_javascripts/styleswitcher.js?original=1
function setActiveStyleSheet(title,reset){if(!W3CDOM){return false};var i,a,main;for(i=0;(a=document.getElementsByTagName("link")[i]);i++){if(a.getAttribute("rel").indexOf("style")!=-1&&a.getAttribute("title")){a.disabled=true;if(a.getAttribute("title")==title){a.disabled=false}}}
if(reset==1){createCookie("wstyle",title,365)}};
function setStyle(){var style=readCookie("wstyle");if(style!=null){setActiveStyleSheet(style,0)}};registerPloneFunction(setStyle);

/* - table_sorter.js - */
// http://edrndemo.org/portal_javascripts/table_sorter.js?original=1
...
// http://edrndemo.org/portal_javascripts/calendar_formfield.js?original=1
...
/* - calendarpopup.js - */
// http://edrndemo.org/portal_javascripts/calendarpopup.js?original=1
function showDay(date){document.getElementById('day'+date).style.visibility='visible';return true}
function hideDay(date){document.getElementById('day'+date).style.visibility='hidden';return true}


/* - ie5fixes.js - */
// http://edrndemo.org/portal_javascripts/ie5fixes.js?original=1
...
/* - formUnload.js - */
// http://edrndemo.org/portal_javascripts/formUnload.js?original=1
...
/* - sarissa.js - */
// http://edrndemo.org/portal_javascripts/sarissa.js?original=1
...
/* - login.js - */
// http://edrndemo.org/portal_javascripts/login.js?original=1
...
// http://edrndemo.org/portal_javascripts/formsubmithelpers.js?original=1
...
/* - edrn.js - */
// http://edrndemo.org/portal_javascripts/edrn.js?original=1
