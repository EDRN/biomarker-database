// Javascript
	...
	var Biomarker = {
		Version: '1.0',
		CreateHandler: siteBaseUrl + '/model/AjaxHandler.php',
		LinkHandler:   siteBaseUrl + '/model/AjaxHandler.php',
		UnlinkHandler: siteBaseUrl + '/model/AjaxHandler.php',
		DeleteHandler: siteBaseUrl + '/model/AjaxHandler.php',
