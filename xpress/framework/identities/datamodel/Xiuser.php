	...
	public static function Retrieve($value,$key = XiuserVars::OBJID,$fetchStrategy = XPress::FETCH_LOCAL) {
		...
		switch ($key) {
			case XiuserVars::OBJID:
				...
				$o->setObjectId($data['ObjectId']);
				$o->setUserName($data['UserName']);
				$o->setPassword($data['Password']);
				$o->setEmailAddress($data['EmailAddress']);
				$o->setCreated($data['Created']);
				$o->setStatus($data['Status']);
				$o->setLastLogin($data['LastLogin']);
				return $o;
				break;
			case XiuserVars::USERNAME:
				...
				$o->EmailAddress = $data['EmailAddress'];
				$o->Created = $data['Created'];
				$o->Status = $data['Status'];
				$o->LastLogin = $data['LastLogin'];
				return $o;
				break;
			case XiuserVars::EMAILADDRESS:
				$o->setEmailAddress($value);
