...
$associateDisplay = <<<ENDASSOCDISPLAY
			...
			PubMed ID:&nbsp;
				...
				<input type="button" value="Associate" onclick="linkStudyPublication({$object->getObjId()},$('assocPubAutocompleteID').getValue());"/>
...
ENDASSOCDISPLAY;
	...
	if (sizeof($object->getPublications()) == 0){
		$pubDisplay = 'There is no publication data associated with this study.';
	} else {
