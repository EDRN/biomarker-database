<?php
	...
	$popcharEditor = AjaxEditors::create('model/AjaxHandler.php',$object->getBiomarkerPopulationCharacteristics(),"bpc","bpc",$object->_getType(),$object->getObjId(),StudyVars::STU_BIOMARKERPOPULATIONCHARACTERISTICS);
