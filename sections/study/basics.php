<?php
	...
	$popcharEditor = AjaxEditors::createSelect('model/AjaxHandler.php',$object->getBiomarkerPopulationCharacteristics(),"bpc","bpc",$object->_getType(),$object->getObjId(),StudyVars::STU_BIOMARKERPOPULATIONCHARACTERISTICS,array("1"=>"Case/Control","2"=>"Longitudinal","3"=>"Randomized"),'','click to select');
	...
	$studydesignEditor = AjaxEditors::createSelect('model/AjaxHandler.php',$object->getDesign(),"design","design",$object->_getType(),$object->getObjId(),StudyVars::STU_DESIGN,array("Retrospective"=>"Retrospective","Prospective Analysis"=>"Prospective Analysis","Cross Sectional"=>"Cross Sectional"),'','click to select');
	...
	$studytypeEditor = AjaxEditors::createSelect('model/AjaxHandler.php',$object->getBiomarkerStudyType(),"studytype","studytype",$object->_getType(),$object->getObjId(),StudyVars::STU_BIOMARKERSTUDYTYPE,array("Unregistered"=>"Unregistered","Registered"=>"Registered"),'','click to select');
