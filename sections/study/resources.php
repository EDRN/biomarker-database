...
$associateDisplay = <<<ENDASSOCDISPLAY
			...
			<table>
				...
				<tr><td><input type="button" value="Associate" onclick="createStudyResource({$object->getObjId()},$('assocPubAutocompleteID').getValue());"/></td>
...
ENDASSOCDISPLAY;
	...
	if (sizeof($object->getResources()) == 0){
		$resDisplay = 'There are no resources associated with this study.';
	} else {
