...
$associateDisplay = <<<ENDASSOCDISPLAY
			<h3>Add publication data to {$object->getBiomarker()->getTitle()} / {$object->getOrgan()->getName()}</h3>
			...
			PubMed ID:&nbsp;
				...
				<input type="button" value="Associate" onclick="linkBiomarkerOrganPublication({$object->getObjId()},$('assocPubAutocompleteID').getValue());"/>
