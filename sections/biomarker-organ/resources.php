...
$associateDisplay = <<<ENDASSOCDISPLAY
			<h3>Add a resource to {$object->getBiomarker()->getTitle()}/{$object->getOrgan()->getName()}</h3>
			<table>
				...
				<tr><td><input type="button" value="Associate" onclick="createBiomarkerOrganResource({$object->getObjId()},$('assocPubAutocompleteID').getValue());"/></td>
