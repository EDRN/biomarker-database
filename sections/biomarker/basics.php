<?php
	...
	$phaseEditor = AjaxEditors::createSelect('model/AjaxHandler.php',$object->getPhase(),"phase","phase",$object->_getType(),$object->getObjId(),BiomarkerVars::BIO_PHASE,array(array("value"=>"1","label"=>"One (1)"),array("value"=>"2","label"=>"Two (2)"),array("value"=>"3","label"=>"Three (3)"),array("value"=>"4","label"=>"Four (4)"),array("value"=>"5","label"=>"Five (5)")),'','click to select');
